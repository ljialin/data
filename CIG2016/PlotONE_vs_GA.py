...
if __name__=="__main__":
    ...
    DATA_FILES = ["./data/ONESTEP-RND_10x1_vs_GA_100x100.txt","./data/ONESTEP-RND_5x2_vs_GA_100x100.txt",
                  "./data/ONESTEP-RND_2x5_vs_GA_100x100.txt", "./data/ONESTEP-RND_1x10_vs_GA_100x100.txt"]
    output_file = './plots/ONESTEP_XXxXX_vs_GA-RND_100x100'
    ...
    DATA_FILES = ["./data/ONESTEP-RND_1x5_vs_GA_100x100.txt","./data/ONESTEP-RND_1x10_vs_GA_100x100.txt",
            "./data/ONESTEP-RND_1x25_vs_GA_100x100.txt", "./data/ONESTEP-RND_1x50_vs_GA_100x100.txt"]
    output_file = './plots/ONESTEP_1xXX_vs_GA-RND_100x100' 
    labels = []
    for d in DATA_FILES:                                                        
        labels.append(d[7:-4])
