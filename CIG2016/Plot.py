...
if __name__=="__main__":
    ...
    DATA_FILES = ["./data/GA-RND_10x1_vs_RND_100x100.txt","./data/GA-RND_5x2_vs_RND_100x100.txt",
                  "./data/GA-RND_2x5_vs_RND_100x100.txt", "./data/GA-RND_1x10_vs_RND_100x100.txt"]
    output_file = './plots/GA-RND_1xXX_vs_RND_100x100'
